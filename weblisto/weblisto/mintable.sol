...
contract ERC721Base is HasSecondarySaleFees, ERC721, HasContractURI, HasTokenURI, ERC721Enumerable {
    ...
    function updateRoyalityLimit(uint16 _royalityLimit) public onlyOwner {
        require(_royalityLimit <= 10000, "Royality limit must be below 100% ");
        royalityLimit = _royalityLimit;
    }

    function updateMintingCharge(uint _mintingCharge) public onlyOwner {
        mintingCharge = _mintingCharge;
    }
    ...
    function _mint(address to, uint256 tokenId,  uint _royality) internal payable {
